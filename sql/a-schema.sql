...
CREATE TYPE hole AS ENUM (
    ...
    'integer-roots', 'intersection', 'inventory-sequence', 'isbn',
    'jacobi-symbol', 'kaprekar-numbers', 'kolakoski-constant',
    'kolakoski-sequence', 'langtons-ant', 'leap-years',
    'levenshtein-distance', 'leyland-numbers', 'ln-2', 'look-and-say',
    'lucky-numbers', 'lucky-tickets', 'lyndon-factorization', 'mahjong',
    ...
    'number-spiral', 'numbrix', 'odd-polyomino-tiling',
